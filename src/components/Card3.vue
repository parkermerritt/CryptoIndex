...
.container:first-child .front {
  background: #5271C2;
}

.container:first-child .card__name {
...
.container:nth-child(2) .card__name {
...
.container:nth-child(3) .card__name {
...
.container:nth-child(4) .front {
  background: #db6623;
}
.container:nth-child(4) .card__name {
...
.container:nth-child(5) .front {
  background: #3e5eb3;
}
.container:nth-child(5) .card__name {
...
.container:nth-child(6) .front {
  background: #aa9e5c;
}
.container:nth-child(6) .card__name {
